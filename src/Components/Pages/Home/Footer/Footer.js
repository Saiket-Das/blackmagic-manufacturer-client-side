        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content lg:flex justify-around">
                <div>
                    ...
                    <Link to='#' className="link link-hover">Product Development </Link>
                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <Link to='#' className="link link-hover">About us</Link>
                    <Link to='#' className="link link-hover">Contact us</Link>
                    <Link to='#' className="link link-hover">Find your jobs</Link>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 flex justify-center">
                <div className="items-center grid-flow-col">
                    ...
                    <p>
                        <span className='font-semibold'>Black Magic Industries Ltd.</span>
                        <br />
                        Copyright © 2022 - All right reserved by Black Magic
                    </p>
                </div>
            </footer>
        </div>
